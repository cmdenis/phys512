...
@nb.njit
def rho_maker1(loc, masses, rho):
    # Function to add the masses to the density matrix
    for pos, m in zip(loc, masses): 
        # Iterating over all particles' locations 
        # and appending their masses
        rho[pos[0], pos[1]] += m
...
class Particles:
    ...
    def get_rho(self):
        ...
        self.rho[:]=0
        rho_maker(self.x, self.rho, self.m)
