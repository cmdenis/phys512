...
# Calculating the cavity width 

# Width
width = best_param[2]/best_param[-1] * 9


# Then the error
error_width = param_std[2]/param_std[-1] * 9
          
print("The width of the cavity is", width,"with error", error_width, "GHz")
